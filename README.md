...
6. Получите api-ключ в сервисе Priceva, следуя [данной инструкции﻿](https://priceva.ru/knowledge/kak-poluchit-dostup-k-api/).
    
7. Настройте модуль на странице `Администрирование / Настройки / Настройки продукта / Настройка модулей / Priceva: Коннектор`.
