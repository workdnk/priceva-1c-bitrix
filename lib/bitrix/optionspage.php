...
class OptionsPage
{
    const TOOLTIPS = [
        ...
        "SYNC_FIELD"                  => 'Здесь вы можете выбрать, что конкретно будет использоваться в качестве поля, по которому будут синхронизироваться ваши товары между вашим аккаунтом в сервисе Priceva и вашим сайтом. Есть два варианта: "Артикул" и "Внутренний код клиента". В первом случае, для синхронизации товаров между вашим сайтом и Priceva будет использовать артикул, который есть в обоих системах. Во втором случае, вы сможете выбрать в поле ниже, что будет служить "внутренним кодом клиента".',
        "CLIENT_CODE"                 => 'Какое из полей системы Bitrix будет использовано в качестве аналога внутреннего код клиента из системы Priceva. Доступно два варианта: "ID товара" и "символьный код товара". Выбранный вами вариант будет взять из системы Bitrix и сравнен с "внутренний код клиента" в Priceva',
